...
PADCHAR = "=", ALPHA = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", getbyte = function(t, e) {
...
btoa = function(t) {
    ...
    for (e = 0; e < s; e += 3)
    i = p(t, e) << 16 | p(t, e + 1) << 8 | p(t, e + 2), r.push(o.charAt(i >> 18)), r.push(o.charAt(i >> 12 & 63)), r.push(o.charAt(i >> 6 & 63)), r.push(o.charAt(63 & i));
    switch (t.length - s) {
        case 1:
...
function get_token() {
	...
	tokens = hex_md5(btoa('9622' + timestamp))
	return tokens
}
